...
report is the exception: a warning, or a relationship the client could not write,
opens that task's detail page, because that is the only place its message and retry
actions exist.
